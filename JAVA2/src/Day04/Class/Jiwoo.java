...
public class Jiwoo {
	public static void main(String[] args) {
		...
		Pikachu pikachu30 = new Pikachu(150);
		System.out.println("::::::::피카츄:::::::");
		System.out.println("에너지 : " + pikachu30.energy);
		System.out.println("타입 : " + pikachu30.type);
		System.out.println("공격A : " + pikachu30.aAttack());
		System.out.println("공격B : " + pikachu30.bAttack());
		System.out.println();
