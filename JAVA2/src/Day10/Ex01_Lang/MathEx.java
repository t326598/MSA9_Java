...
public class MathEx {
	public static void main(String[] args) {
		System.out.println(Math.PI); // 3.1415926535 (원주율)
		System.out.println(Math.E); // 2.71828182845 (자연상수)
		...
		// Math.random() : 0.0xxxxx ~ 0.9xxx
		// (0.0xxxxx ~ 0.9xxx) * 10 : 0.xxxxx ~ 9.xxxx 10개
		// (0.0xxxxx ~ 0.9xxx) * 20 : 0.xxxxx ~ 19.xxxx 20개
		// (0.0xxxxx ~ 0.9xxx) * 45 : 0.xxxxx ~ 44.xxxx 45개
		// (0.0xxxxx ~ 0.9xxx) * 45+1 : 1.xxxxx ~ 45.xxxx
		// (int)(Math.random(0* [개수]) + [시작숫자]
