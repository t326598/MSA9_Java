...
public class ArraysEx {
	public static void main(String[] args) {
		...
		if( result < 0) {
			...
			System.out.println("insertion point" + result); //존재했다면 있어야할 위치 표시
		}
		else {
			System.out.println("랜덤 수 10위 위치(index) : " + result);
		}
	...
	//Array.copyOfRange(배열, 시작 index, 끝 index+1
	// : 배열 시작 index ~ 끝 index 까지의 요소를 복사하야 새 배열로 반환
	int copyRange[] = Arrays.copyOfRange(random, 11, 21);   // inde 11 ~ 20까지 복사
